...
export default function DashboardPage() {
  ...
  const kpiCards = [
    ...
    { title: t('finance.expense'), value: formatKpiCurrency(kpis?.monthlyExpenses), icon: TrendingDown, color: '#f43f5e', trend: 'down' as const, change: t('finance.expense'), href: '/finance/fund-expenses' },
